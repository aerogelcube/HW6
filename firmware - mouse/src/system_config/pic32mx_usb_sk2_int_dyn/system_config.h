...
#define SYS_PORT_B_TRIS         0xdfff //was originally port b, fff8
...
#define APP_USB_SWITCH_1    BSP_SWITCH_1 // was BSP_SWITCH_1, which was on PORTS_BIT_POS_6,
                                         // but our switch is on PORTS_BIT_POS_13, which
                                         // happens to be defined on BSP_SWITCH_3
